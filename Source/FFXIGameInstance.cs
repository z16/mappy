...
namespace mappy {
   public class FFXIGameInstance : GameInstance, IFFXIGameContainer, IFFXIMapImageContainer {
      ...
      public FFXIGameInstance(Engine engine, Config config, string FilePath, string ModuleName) : base(engine, config, ModuleName) {
      ...
      public FFXIGameInstance(Process process, Engine engine, Config config, string FilePath, string ModuleName) : base(engine, config, ModuleName) {
         m_ServerIDLookup = new Dictionary<uint, FFXISpawn>();
         m_zoneNameShort = new List<string>();
         lastZone = 0;
